...
def train_mc(iterations, command_config, reward_config, dr_config, eureka_target_velocity=None,
    ...
    from forward_locomotion_roboclip.go1_gym.envs.base.legged_robot_config import Cfg, set_seed
    from forward_locomotion_roboclip.go1_gym.envs.go1.go1_config import config_go1
    from forward_locomotion_roboclip.go1_gym.envs.mini_cheetah.velocity_tracking import VelocityTrackingEasyEnv
    from forward_locomotion_roboclip.go1_gym_learn.ppo import Runner
    from forward_locomotion_roboclip.go1_gym.envs.wrappers.history_wrapper import HistoryWrapper
    from forward_locomotion_roboclip.go1_gym_learn.ppo.actor_critic import AC_Args
    from forward_locomotion_roboclip.go1_gym_learn.ppo.ppo import PPO_Args
    from forward_locomotion_roboclip.go1_gym_learn.ppo import RunnerArgs
    ...
    wandb.init(
        project="forward_locomotion_roboclip",
        entity="upenn-pal",
...
if __name__ == '__main__':
    ...
    logger.configure(logger.utcnow(f'forward_locomotion_roboclip/%Y-%m-%d/{stem}/%H%M%S.%f'),
